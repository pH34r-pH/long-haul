...
def main() -> None:
    ...
    reference=sub.add_parser("validate-reference"); reference.add_argument("--binary",required=True); reference.add_argument("--model",required=True); reference.add_argument("--output",default="reference-run"); reference.add_argument("--timeout",type=float,default=900)
    args=p.parse_args()
