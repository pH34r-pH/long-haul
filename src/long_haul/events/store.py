...
EventType = Literal["observation", "self_report", "inference", "unknown", "request", "decision", "embodiment_change", "competence_update", "rupture", "repair", "work_contract_created", "work_attempt_completed", "work_evidence", "work_disposition", "work_fact", "work_constraint", "work_subgoal", "work_failure", "work_failure_resolved", "work_artifact_verified", "evaluation_started", "evaluation_evidence", "evaluation_regression", "work_progress_intervention", "work_attempt_handed_back"]
